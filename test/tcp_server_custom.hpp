#ifndef ASIO_TEST_TCP_SERVER_2
#define ASIO_TEST_TCP_SERVER_2
...
class tcp_server_custom
{
public:
  tcp_server_custom(boost::asio::io_service& io_service)
...
private:
  void start_accept()
  {
    ...
    acceptor_.async_accept(new_connection->socket(),
      bind(&tcp_server_custom::handle_accept, this, new_connection,
